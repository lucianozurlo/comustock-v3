...
function cs_Contact_Form () {
  ...
  // Contact Form
  if (jQuery ('.cs-contact-form:not(.is-init)').length) {
    jQuery ('.cs-contact-form:not(.is-init)').each (function () {
      let $form = jQuery (this),
        $response = $form.find ('.cs-contact-form__response'),
        formData;
      ...
      $form.on ('submit', function (e) {
        ...
        jQuery
          ...
          .done (function (response) {
            ...
            $response
              .empty ()
              .removeClass ('cs-alert-danger')
              .addClass ('cs-alert-success')
              .slideDown (200);
          ...
          .fail (function (data) {
            ...
            $response
              .empty ()
              .removeClass ('cs-alert-success')
              .addClass ('cs-alert-danger')
              .slideDown (200);
