...
const cs_config = {
  ...
  // Cursor Following
  cursorFollow: ".cs-buttons-list a, .cs-gallery-nav",
...
jQuery(function ($) {
  ...
  const core = new ST_Core(cs_config);
  ...
  function MainMenuInit() {
    template.menu = new cs_Menu(core);
  }

  // --- PHOTOSWITE LIGHTBOX --- //
  function initPSWP() {
    if (jQuery(".cs-lightbox-link").length) {
      if (typeof PhotoSwipe === "function") {
                        ...
                        <div class="pswp__scroll-wrap">\
                            ...
                            <div class="pswp__ui pswp__ui--hidden">\
                                <div class="pswp__top-bar">\
                                    ...
                                    \
                                    <button class="pswp__button pswp__button--close cs-pswp-close" title="Close (Esc)">\
                                        <i></i>\
                                    </button>\
                                    \
                                ...
                                \
                                <button class="pswp__button cs-pswp-nav cs-pswp-prev pswp__button--arrow--left" title="Previous (arrow left)"></button>\
                                <button class="pswp__button cs-pswp-nav cs-pswp-next pswp__button--arrow--right" title="Next (arrow right)"></button>\
                                \
        ...
        // Build PSWP Gallery
        jQuery(".cs-lightbox-link").each(function () {
          ...
          if ($this.attr("data-type") && $this.attr("data-type") !== "image") {
            ...
            if ("video" === $this.attr("data-type")) {
              this_item.html =
                '\
                            <div class="cs-pswp-media--video" data-src="' +
                $this.attr("href") +
                '">\
                                <video src="' +
                $this.attr("href") +
              ...
              this_item.html =
                '\
                            <div class="cs-pswp-media--iframe" data-player-src="' +
                this_link +
                '" data-src="' +
                $this.attr("href") +
                '" data-type="' +
        ...
        core.$dom.body.on("click", ".cs-pswp-image-wrap", function (e) {
          e.preventDefault();
          e.stopPropagation();
        });
        core.$dom.body.on(
        ...
        jQuery(document).on("click", ".cs-lightbox-link", function (e) {
          e.preventDefault();
          if (typeof PhotoSwipe === "function") {
            let $this = jQuery(this),
            ...
            template.pswp.lightbox.listen("resize", function () {
              if (
                ...
                jQuery(template.pswp.lightbox.container)
                  .find(".cs-pswp-media--video")
                  .width(template.pswp.resizeVideo().w)
                  .height(template.pswp.resizeVideo().h);
              }
              if (
                jQuery(template.pswp.lightbox.container).find(
                  ".cs-pswp-media--iframe"
                ).length
              ) {
                jQuery(template.pswp.lightbox.container)
                  .find(".cs-pswp-media--iframe")
                  .width(template.pswp.resizeVideo().w)
                  .height(template.pswp.resizeVideo().h);
              }
            });
        ...
        console.error("ComuStock Error: PSWP script not found.");
      }
    }
  }
  ...
  function HeroSections() {
    // Masked Blocks
    if (jQuery(".cs-masked-block").length) {
      jQuery(".cs-masked-block").each(function () {
        new cs_Masked(this);
      });
    }
  }
  ...
  function BlocksHighlight() {
    if (jQuery(".cs-backlight").length) {
      ...
      jQuery(document).on("mousemove", function (e) {
        ...
        jQuery(".cs-backlight").css({
          "--mouse-x": `${template.cursor_pos.x}px`,
          "--mouse-y": `${template.cursor_pos.y}px`,
        });
      });

      if (jQuery(".cs-block").length) {
        jQuery(".cs-block").each(function () {
  ...
  // --- MARQUEE ELEMENT --- //
  function Marquee() {
    if (jQuery(".cs-marquee").length) {
      jQuery(".cs-marquee").each(function () {
        new cs_Marquee(this);
      });
    }
  }
    ...
    if (jQuery(".swiper").length) {
      ...
      const init_swiper = function () {
        ...
        jQuery(".swiper").each(function () {
          ...
          if (core.$dom.body.hasClass("cs-fullscreen-page")) {
            options.mousewheel = true;
          }
          // CAROUSEL
          if ($this.hasClass("cs-carousel")) {
          ...
          if ($this.hasClass("cs-slider")) {
            ...
            // Slider Content
            if ($this.find(".cs-slide-content").length) {
              let content_mask_id =
              ...
              $this
                ...
                .each(function (i) {
                  ...
                  if ($slide.children(".cs-slide-content").length) {
                    const $slide_content = $slide.children(".cs-slide-content");
                    ...
                    $media.wrap('<div class="cs-slider-media"/>');
          ...
          // Pagination
          if ($this.children(".cs-dots").length) {
            options.pagination = {
              el: ".cs-dots",
              dynamicBullets: true,
          ...
          // Slider Navigation
          if ($this.parent().children(".cs-slider-nav").length) {
            let $this_nav = $this.parent().children(".cs-slider-nav");
            options.navigation = {
              prevEl: $this_nav.children(".cs-slider-prev")[0],
              nextEl: $this_nav.children(".cs-slider-next")[0],
            };
      ...
      if (typeof Swiper === "function") {
        ...
        console.error("ComuStock Error: Swiper Library not found.");
      }
    }
  }
  ...
  function CircleLinks() {
    if (jQuery(".cs-circle-path-link:not(.is-init)").length) {
      jQuery(".cs-circle-path-link:not(.is-init)").each(function () {
        let $this = jQuery(this),
          size =
  ...
  function LinksEvents() {
    jQuery(".cs-back-to-listing").on("click", function () {
    ...
    if (
      jQuery(".cs-albums-listing").length &&
      window.localStorage.getItem("cs_return_from") != false
    ) {
      jQuery(window).trigger(
        "cs_set_album",
        window.localStorage.getItem("cs_return_from")
      );
      window.localStorage.setItem("cs_return_from", 0);
    } else {
      window.localStorage.setItem("cs_return_from", 0);
    }
  }
  ...
  function InfiniteList() {
    if (jQuery(".cs-infinite-list-wrap:not(.is-init)").length) {
      jQuery(".cs-infinite-list-wrap:not(.is-init)").each(function () {
        this.classList.add("is-init");
        core.updateRequired.push(new cs_Infinite_List(this));
      });
    }
  }
  ...
  // --- COUNTERS --- //
  function Counters() {
    if (jQuery(".cs-counter:not(.is-init)").length) {
      jQuery(".cs-counter:not(.is-init)").each(function () {
        let $this = jQuery(this);
        this.classList.add("is-init");
        this.counter_count = function () {
          let $counter = $this.children(".cs-counter-number");
  ...
  function ListWithPreview() {
    if (jQuery(".cs-list-with-preview").length) {
      jQuery(".cs-list-with-preview").each(function () {
        new cs_LWP(this);
      });
    }
  }
  ...
  function BeforeAfter() {
    if (jQuery(".cs-before-after:not(.is-init)").length) {
      jQuery(".cs-before-after:not(.is-init)").each(function () {
        jQuery(this).addClass("is-init");
        core.updateRequired.push(new cs_Before_After(jQuery(this)));
      });
    }
  }
  ...
  // --- TOGGLES --- //
  function Toggles() {
    jQuery(".cs-toggles-item:not(.is-init)").each(function () {
      let $this = jQuery(this);
      $this.addClass("is-init");
      $this
        .children(".cs-toggles-item--title")
        .append('<i class="cs-icon cs-icon-arrow-down"/>');
      $this.children(".cs-toggles-item--content").slideUp(1);

      // Manejador único en el contenedor:
      $this.on("click", function (e) {
        // Si el clic (o alguno de sus padres) tiene el atributo data-fancybox, no ejecutar toggle.
        if (jQuery(e.target).closest("[data-fancybox]").length) {
          // Permitir que el enlace fancybox maneje el clic y no se cierre el acordeón.
          return;
        }
        $this.toggleClass("is-active");
        $this.children(".cs-toggles-item--content").slideToggle(300);
      });
    });
  }
  ...
  function ScrollTrigger() {
    ...
    if (jQuery(".cs-inline-ribbon:not(.is-init)").length) {
      jQuery(".cs-inline-ribbon:not(.is-init)").each(function () {
        if (core.sap !== null) {
          let $this = jQuery(this);
          $this.addClass("is-init");
    ...
    // Sticky Elements
    if (jQuery(".cs-sticky-block:not(.is-init)").length) {
      jQuery(".cs-sticky-block:not(.is-init)").each(function () {
        if (core.sap !== null) {
          let $this = jQuery(this);
          $this.addClass("is-init");
    ...
    // Expand on Scroll
    if (jQuery(".cs-expand-on-scroll:not(.is-init)").length) {
      jQuery(".cs-expand-on-scroll:not(.is-init)").each(function () {
        if (core.sap !== null) {
          let $this = jQuery(this);
          $this.addClass("is-init");
    ...
    // Text Mask Fill
    if (jQuery(".cs-text-fill-mask:not(.is-init)").length) {
      jQuery(".cs-text-fill-mask:not(.is-init)").each(function () {
        if (core.sap !== null) {
          let $this = jQuery(this);
          $this.addClass("is-init");
    ...
    // Parallax Media
    if (jQuery(".cs-parallax-media:not(.is-init)").length) {
      jQuery(".cs-parallax-media:not(.is-init)").each(function () {
        let $this = jQuery(this);
        if (
  ...
  function ContactForm() {
    if (jQuery(".cs-contact-form").length) {
      // The code related to the contact form is in the file: assets/js/contact_form.js
      if (typeof cs_Contact_Form === "function") {
        cs_Contact_Form();
      } else {
        console.error("ComuStock Error: Contact form script not found.");
      }
    }
  }
  ...
  function InitAnimation() {
    ...
    template.checkURL = function (el) {
      ...
      if (this_href.indexOf("javascript") === 0) {
        ...
        jQuery(cs_config.linksException).each(function () {
          if ($el.is(this)) {
            result = false;
          }
        });
  ...
  function Layout() {
    ...
    core.$dom.nav.find(".cs-menu-offset").removeClass("cs-menu-offset");
    ...
    if (core.$dom.body.hasClass("cs-fullscreen-page")) {
      ...
      core.$dom.main.removeClass("cs-min-content");
      ...
      if (core.$dom.main.height() < minHeight) {
        core.$dom.main.addClass("cs-min-content");
  ...
  $(document).ready(function () {
    // General UI
    RightClickProtection(".cs-rcp-wrap");
    MainMenuInit();
    CircleLinks();
